var app = angular.module('facebookMach');
...
//ascending and descending
	// var $scope.asc = false;
	// $scope.ordFriends = function() {
	// 	$scope.asc = !$scope.asc;
	// };

	$scope.options = [{raw: "name", pretty: "Name"},{raw: "friend_count", pretty: "# friends"}, {raw: "current_location.city", pretty: "City"}, {raw: "current_location.state", pretty: "State"}, {raw: "current_location.country", pretty: "Country"}];
...
for (var i = 0; i < $scope.friends.length; i++) {
	$scope.friends[i].friend_count = Number($scope.friends[i].friend_count);	
}
